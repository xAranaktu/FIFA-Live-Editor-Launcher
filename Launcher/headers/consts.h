...
inline const int EAFC_EDITION = 26;
inline const char* TOOL_NAME = "Live Editor";
inline const char* GAME_WINDOW_CLS = "EA SPORTS FC 26";
inline const __int64 UNLOCK_FREE = 1782128216;
inline const __int64 UNLOCK_BRONZE = 1782128216;
