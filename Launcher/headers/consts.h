...
inline const char* TOOL_VERSION = "v25.2.6";
...
inline const std::vector<std::string> COMPATIBLE_TITLE_UPDATES = {
    "TU2", "TU3", "TU4", "TU5", "TU6", "TU6.1", "TU7"
};

inline const int LATEST_TU = 7;
inline const int LATEST_MAJOR_GAME_VER = 117;
inline const int LATEST_MINOR_GAME_VER = 63822;
