...
namespace LE {
    ...
    private:
        ...
        std::string latest_tool_version = "v26.3.5";
        std::string tool_version = "v26.3.5";
        ...
        std::map<std::string, std::string> game_version_map = {
            ...
            { "1.0.136.4893",       "v1.6.0"},
            { "1.0.135.54147",      "v1.5.6"},
            { "1.0.135.39173",      "v1.5.5"},
            { "1.0.134.63314",      "v1.5.4"},
            { "1.0.134.1759",       "v1.5.3"},
            { "1.0.133.58379",      "v1.5.2"},
            { "1.0.133.14157",      "v1.5.1"},
            { "1.0.132.29676",      "v1.5.0"},
            { "1.0.131.50017",      "v1.4.3"},
        ...
        std::map<std::string, std::vector<std::string>> game_version_compatibility = {
            ...
            { "1.0.136.4893",       { "v26.3.3", "v26.3.3" }},
            { "1.0.135.54147",      { "v26.3.0", "v26.3.2" }},
            { "1.0.135.39173",      { "v26.3.0", "v26.3.2" }},
            { "1.0.134.63314",      { "v26.3.0", "v26.3.2" }},
            { "1.0.134.1759",       { "v26.3.0", "v26.3.2" }},
            { "1.0.133.58379",      { "v26.2.7", "v26.2.9" }},
            { "1.0.133.14157",      { "v26.2.7", "v26.2.9" }},
            { "1.0.132.29676",      { "v26.2.7", "v26.2.9" }},
            { "1.0.131.50017",      { "v26.2.3", "v26.2.6" }},
