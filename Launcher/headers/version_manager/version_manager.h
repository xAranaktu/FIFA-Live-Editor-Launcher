...
namespace LE {
    ...
    private:
        ...
        std::string latest_tool_version = "v26.2.7";
        std::string tool_version = "v26.2.7";
        ...
        std::map<std::string, std::vector<std::string>> game_version_compatibility = {
            { "1.0.131.50017",      { "v26.2.3", "v26.2.7" }},
            { "1.0.131.24706",      { "v26.2.3", "v26.2.7" }},
            { "1.0.130.35129",      { "v26.2.3", "v26.2.7" }},
            { "1.0.130.16994",      { "v26.2.3", "v26.2.7" }},
